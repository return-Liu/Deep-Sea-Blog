export const ja = {
  ...
  settings: {
    ...
    profile: {
      ...
      FeatureCode:
        "特徴コード（用途：クライアントがユーザーを一意に識別するため）",
      gender: "性別",
      male: "男",
      female: "女",
      secret: "非公開",
      ...
      constellation: "星座",
      signature: "個性の署名",
      signaturePlaceholder: "自己紹介して、個性の署名を残してください...",
      saveChanges: "変更を保存",
      ...
      cancel: "キャンセル",
      confirmCrop: "してアバターを切り抜く",
      cropperNotInitialized: "クリpperが初期化されていません",
      cropFailed: "切り抜きに失敗しました",
      selectImage: "再選択",
      Previewavatar: "プレビューアバター",
      cannotGetCropResult: "切り抜き結果を取得できません",
    },
    security: {
      logout: "ログアウト",
      logoutDesc: "現在のアカウントのログイン状態を終了します",
      delete: "アカウントを削除",
      deleteDesc:
        "すべてのデータを永久に削除します。この操作は取り消せません。",
      changePassword: "パスワードを変更",
      changePasswordDesc:
        "アカウントのパスワードを変更して、アカウントのセキュリティを確保します",
    },
    likes: {
      title: "私のいいね",
      noLikes: "まだいいねがありません~",
      noLikesDesc: "探索して、気に入ったコンテンツにいいねを押してください~",
    },
    mode: {
      mode: "モード選択",
      description: "夜間モード",
